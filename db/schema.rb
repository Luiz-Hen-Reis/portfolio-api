...
ActiveRecord::Schema[7.1].define(version: 2024_01_01_154508) do
  ...
  create_table "project_tecnologies", force: :cascade do |t|
    ...
    t.bigint "tecnology_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_id"], name: "index_project_tecnologies_on_project_id"
    t.index ["tecnology_id"], name: "index_project_tecnologies_on_tecnology_id"
  end
  ...
  create_table "tecnologies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["institution_id"], name: "index_tecnologies_on_institution_id"
  end
